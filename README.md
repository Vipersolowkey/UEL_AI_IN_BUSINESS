...
*Nếu giám khảo **không chạy được** môi trường trên máy: có thể yêu cầu nhóm sinh viên **chiếu màn hình** hoặc cung cấp **video ngắn / slide** đi cùng.*

---

## Thuật ngữ thường gặp (giải thích đơn giản)

- **Dashboard / Overview**: Màn hình tổng hợp số liệu và cảnh báo để lãnh đạo nắm nhanh tình hình.
- **AI trong demo**: Hệ thống có thể gọi dịch vụ AI bên ngoài để **viết phân tích / gợi ý** dựa trên **số liệu đưa vào**. Nếu chưa cấu hình khóa AI, một số chức năng vẫn chạy bằng **luật đơn giản có sẵn** (không phải “ảo”).
- **SQLite**: Cơ sở dữ liệu **một file trên máy**, đủ cho demo; không cần cài thêm máy chủ cơ sở dữ liệu phức tạp để chấm điểm.

---

## Cách chạy demo trên máy (cho người hỗ trợ kỹ thuật hoặc sinh viên)
...
*Tài liệu chi tiết song ngữ / kỹ thuật bổ sung có thể có trong [TAI_LIEU_DU_AN.md](TAI_LIEU_DU_AN.md) (nếu nhóm đã chuẩn bị).*
